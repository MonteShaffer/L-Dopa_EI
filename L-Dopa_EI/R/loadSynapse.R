...
#'
#' @examples
#' loadSynapse('./L-Dopa_EI/example/config.txt');
#' 
#' loadSynapse('./L-Dopa_EI/example/config.txt',login=F);
#' 
#' loadSynapse('./L-Dopa_EI/example/config.txt',login=T,synapseUserOverride='monte.shaffer@gmail.com',synapsePassOverride='myNewPassword');
#' 
